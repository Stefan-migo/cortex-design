...
const sectionA = (
  <div style={{ background: '#1a1a2e', width: '100%', aspectRatio: '19/6', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#aab', fontSize: '2rem', fontWeight: 600 }}>
    Section A
  </div>
)
const sectionB = (
  <div style={{ background: '#16213e', width: '100%', aspectRatio: '19/6', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#aab', fontSize: '2rem', fontWeight: 600 }}>
    Section B
  </div>
)
